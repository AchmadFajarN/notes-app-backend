...
exports.up = (pgm) => {
  ...
  */
  ...
  // memberikan constraint foreign key pada kolom note_id terhadap notes.id
  ...
  // memberikan constraint foreign key pada kolom user_id terhadap user.id
